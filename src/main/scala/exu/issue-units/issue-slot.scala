 ...
 */
class IssueSlot(val numWakeupPorts: Int)(implicit p: Parameters) extends BoomModule with IssueUnitConstants {
  ...
  assert(
    !(io.ldspec_dst.valid && io.ldspec_dst.bits === 0.U),
