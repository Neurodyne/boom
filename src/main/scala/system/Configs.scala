...
class SmallRV32UnifiedBoomConfig
    extends Config(
      new WithBootROM ++
        new WithBoomRV32 ++
        new WithRVC ++
...
class SmallBoomAndRocketConfig
    extends Config(
      // final param setup
      new WithBootROM ++
...
class MediumBoomAndRocketConfig
    extends Config(
      // final param setup
      new WithBootROM ++
        new WithRenumberHarts ++
...
class DualMediumBoomAndDualRocketConfig
    extends Config(
      // final param setup
      new WithBootROM ++
        new WithRenumberHarts ++
