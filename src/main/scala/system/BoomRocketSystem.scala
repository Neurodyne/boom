 ...
 */
class BoomRocketSystem(implicit p: Parameters)
    extends BoomRocketSubsystem
 ...
 */
class BoomRocketSystemModule[+L <: BoomRocketSystem](_outer: L)
    extends BoomRocketSubsystemModuleImp(_outer)
